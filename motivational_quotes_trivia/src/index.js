...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_OVER_MESSAGE": "You got %s out of %s questions correct. Thank you for playing!  Goodbye!",
            "SCORE_IS_MESSAGE": "Your score is %s. ",
			"HISTORY_MESSAGE": "You have played %s times.  Your total score is %s. "
        }
    },
    "en-US": {
        "translation": {
            "QUESTIONS" : questions["QUESTIONS_EN_US"],
            "GAME_NAME" : "Motivational Quotes Trivia" // Be sure to change this for your skill.
        }
    },
    "en-GB": {
        "translation": {
...
var APP_ID = process.env.APP_ID;  // TODO replace with your app ID (OPTIONAL).
...
exports.handler = function(event, context, callback) {
	...
	alexa.dynamoDBTableName ='motivationalQuotesTriviaUsers';
...
var startStateHandlers = Alexa.CreateStateHandler(GAME_STATES.START, {
    "StartGame": function (newGame) {
        var speechOutput = newGame ? this.t("NEW_GAME_MESSAGE", this.t("GAME_NAME")) + 
			this.t("HISTORY_MESSAGE", this.attributes['gamesPlayed'].toString(), this.attributes['totalScore'].toString()) +
		...
		for (var i = 0; i < translatedQuestions.length; i++) {
			console.log(">>>" + (i+1) + "<<< " + translatedQuestions[i][Object.keys(translatedQuestions[i])[0]]);
		}
...
function handleUserGuess(userGaveUp) {
    ...
    if (this.attributes["currentQuestionIndex"] == GAME_LENGTH - 1) {
		...
		this.attributes['totalScore'] += currentScore;
